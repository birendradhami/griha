        ...
        <>
          ...
          >
            <div className="relative rounded-full">
              <img
                className="h-8 w-8 sm:h-12 sm:w-12 rounded-full border-2 border-black duration-400 ease-in-out"
            ...
            {isNotify && (
              <p className=" hidden md:block font-heading px-2 py-[2px] rounded-md capitalize  text-xs text-white bg-red-600">
                new!
              </p>
            )}

            {isNotify && (
              <p className="text-red-600 md:hidden font-heading  rounded-md capitalize  text-lg ">
                !
              </p>
            )}
          </div>
          ...
          >
            <div className="relative rounded-full">
              <img
                ...
                alt="user image"
              />
              {/* {conversation.chatPartner.onlineOffline == 1 ? (
                <div className="absolute h-3 w-3 bottom-0 right-0 rounded-full bg-green-600 border-[.1px] border-black"></div>
              ) : (
                <div className="absolute h-3 w-3 bottom-0 right-0 rounded-full bg-gray-400 border-[.1px] border-black"></div>
              )} */}
            </div>
            ...
            {isNotify && (
              <p className="bg-red-600 hidden md:block font-heading px-2 py-[2px] rounded-md capitalize  text-xs text-white">
                new!
              </p>
            )}
