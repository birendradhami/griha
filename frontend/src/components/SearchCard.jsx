...
const SearchCard = ({ listing }) => {
  ...
  return (
    <div className="listing_card pb-6 p-3 sm:p-6 lg:mx-12 bg-white group lg:ml-0 lg:mx-auto">
      <div className="card-container flex flex-col lg:flex-row w-full duration-500 border-2">
        <div
          className="image_container relative lg:border-r-2 overflow-hidden cursor-pointer w-full lg:w-[30%]"
        ...
        <div className="card_body w-full lg:w-[70%] text-black  ">
          <div
