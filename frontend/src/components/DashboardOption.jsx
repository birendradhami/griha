    ...
    return (
      ...
      <div className="flex-none gap-2">
        <div className="dropdown dropdown-end" onClick={toggleDropdown}>
          ...
          >
            <li>
              <Link to={"/dashboard"} className="justify-start py-2 text-black text-[15.5px] sm:text-[16px]">
                <FaUser className="text-black text-[15.5px] sm:text-[16px]" /> Dashboard
              </Link>
            </li>
            <li className="block sm:hidden">
              <Link to={"/saved_listing"} className="justify-start text-black text-[15.5px] sm:text-[16px] py-2">
                <FaHeart className="text-black text-[15.5px] text-base" /> Wishlist
              </Link>
            </li>
            <li className="block sm:hidden">
              <Link to={"/message"} className="justify-start text-black text-[15.5px] sm:text-[16px] py-2">
                <IoChatboxEllipses className="text-black text-[15.5px] sm:text-[16px]" /> Chat
              </Link>
            </li>
            <li
              onClick={() => {
            ...
            >
              <Link className=" text-black text-[15.5px] sm:text-[16px] py-2">
                <FaSignOutAlt className="text-black text-[15.5px] sm:text-[16px]" /> Logout
              </Link>
            </li>
          </ul>
        </div>
